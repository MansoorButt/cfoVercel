...
export function Nav() {
  ...
  return (
    <nav className="hidden min-w-[224px] flex-col gap-3 px-4 lg:flex">
      <Group name="Salaries" isOpen={isSalaries || router.pathname === '/create' || router.pathname === '/withdraw'}>
        ...
        <Spacer />
        <LinkItem name="Create Bulk Payments" href="/create" isActive={router.pathname === '/create'} />
        <Spacer />
        <LinkItem name="Access Streams" href="/withdraw" isActive={router.pathname === '/withdraw'} />
        {/* <Spacer />
        <LinkItem name="Send Single Payment" href="/wi" isActive={router.pathname === '/'} /> */}
      </Group>

      {/* <Group name="NavX" isOpen={isVesting}>
      ...
      <Group name="Paymentz" isOpen={isPayments}>
      ...
      {/* <Group name="" isOpen={router.pathname.includes('/token-salaries')}>
        <LinkItem
          name="Incoming"
